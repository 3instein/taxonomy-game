...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 py-2 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fw-bold fs-3" href="#">Taxev</a>
        ...
        <div class="navbar-nav">
            <form class="nav-item text-nowrap" action="{{ route('logout') }}" method="POST">
                @csrf
                <button class="nav-link px-3 text-dark bg-dark text-white border-0" type="submit">Logout</button>
            </form>
        </div>
    </header>
